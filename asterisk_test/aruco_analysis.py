...
class AstArucoAnalysis():
    ...
    def aruco_analyze_trial(self, trial_name, id):
        """
        Analyzes a folder of aruco images
        """
        trial_folder = self.aruco_pics_loc + trial_name #todo:double check that this is correct
        aruco_loc = self.af.full_Analysis_single_id(trial_folder, id)
